...
<div style="width: 378px; height: 220px;" id="vertgraph">
    ...
    <div id="ylabel" style="top: 27px;">{{chart.ymax}}</div>
    <div id="ylabel" style="top: 172px;">{{chart.ymin}}</div>
    <ul>
        % delta = chart.ymax - chart.ymin
        % if delta:
            % for dt, value in chart.sequence:
            <li style="left: {{dt*6 + 11}}px; height: {{int(value * 145 / delta)}}px;">
                <span>{{value}}</span>
            </li>
            % end
        % end
